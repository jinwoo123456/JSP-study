 ...
 * DB와 연결된 커넥션 인스턴스를 미리 만들어 풀(Pool)에 저장해 두었다가
 * 필요할 때 가져다 쓰고 반납하는 기술을 말한다.DB의 부하를 줄이고 자원을
...
public class DBConnPool {
	...
	public DBConnPool() {
		try {
			...
			/*
			 * 2.앞에서 생성한 인스턴스를 통해 JNDI 서비스 구조의 초기 Root
			...
			System.out.println("db커넥션풀 연결 실패");
			e.printStackTrace();
		}
	}
	public void close() {
