...
<body>
	...
	<form method="post" action="RequestParameter.jsp">
		...
		아이디 : <input type="text" name="id" value="" /><br /> 성별 : <input
			...
			name="sex" value="woman" checked />여자 <br /> 관심사항 : <input
			type="checkbox" name="favo" value="eco" />경제 <input type="checkbox"
			name="favo" value="pol" checked />정치 <input type="checkbox"
			name="favo" value="ent" />연예<br /> 자기소개:
	...
	<a href="RequestHeader.jsp"> <!--HTTP 요청 헤더 읽기--> 요청 헤더 정보 읽기
	</a>
</body>
